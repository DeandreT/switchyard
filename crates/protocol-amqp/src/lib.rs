...
pub use crate::{
    ...
    condition::{
        ...
        MESSAGE_SIZE_EXCEEDED, NOT_ALLOWED, NOT_FOUND, PRECONDITION_FAILED,
    ...
    management::{
        ASSOCIATED_LINK_NAME_PROPERTY, CANCEL_SCHEDULED_MESSAGE_OPERATION,
        ERROR_CONDITION_PROPERTY, EXPIRATION, EXPIRATIONS, GET_SESSION_STATE_OPERATION,
        LOCK_TOKENS, OPERATION_PROPERTY, PEEK_MESSAGE_OPERATION,
        RECEIVE_BY_SEQUENCE_NUMBER_OPERATION, RENEW_LOCK_OPERATION, RENEW_SESSION_LOCK_OPERATION,
        SCHEDULE_MESSAGE_OPERATION, SESSION_ID, SESSION_STATE, SET_SESSION_STATE_OPERATION,
        STATUS_CODE_PROPERTY, STATUS_DESCRIPTION_PROPERTY, TRACKING_ID_PROPERTY,
...
pub enum ProtocolError {
    ...
    #[error("the scheduled enqueue annotation is invalid: {detail}")]
    InvalidScheduledEnqueueTime { detail: String },
}
